...
```{r}
## Create new dataset valid_competitions that will filter data for years 2022-2024 exclusively
valid_competitions <- competitions |>
      filter(year >= 2022 & year <= 2024) |>
      select(id)

# Filter results for only valid competitions, filtering competition count greater than or less than 2
